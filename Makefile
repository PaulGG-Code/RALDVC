...
help:
	...
	@echo "  Linux, macOS (Intel + Apple Silicon), Windows (Docker Desktop)"
	@echo "  The image is pinned to linux/amd64 for consistent x86-64 behaviour."
	@echo "  On Apple Silicon, Docker runs the image via Rosetta 2 emulation."
	@echo "  Requires Docker Desktop on Mac and Windows."
	@echo ""
	...
	@echo ""
	@echo "  cd /lab/exercises"
	@echo "  make check        # run automated pass/fail checks for all exercises"
	@echo ""
